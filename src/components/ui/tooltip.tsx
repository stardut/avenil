...
// Adapted from beUI's public components/motion/tooltip.tsx at commit
// 8d3fa7b4b3b4d74f53ea7096d5eb59e4479c0340. Placement, portal, gesture and
// reduced-motion behavior remain from the source; utility classes are mapped
// to local beui-tooltip-* classes in beui.css for Avenil's plain CSS host.
...
export function Tooltip({
  ...
  return (
    <>
      ...
      <span
        ref={anchorRef}
        className={cn("beui-tooltip-anchor", wrapperClassName)}
              ...
              {open && coords ? (
                ...
                >
                  <motion.span
                    ...
                    className={cn("beui-tooltip", className)}
                  >
                    {content}
                  </motion.span>
                </span>
